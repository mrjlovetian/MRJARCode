...
@property (nonatomic, strong) YHJQRCodeScanningView *scanningView;
@end

@implementation YHJQRCodeScanningVC
...
- (void)dealloc {
    YHJQRCodeLog(@"YHJQRCodeScanningVC - dealloc");
...
- (YHJQRCodeScanningView *)scanningView {
    if (!_scanningView) {
        _scanningView = [YHJQRCodeScanningView scanningViewWithFrame:self.view.bounds layer:self.view.layer];
    }
